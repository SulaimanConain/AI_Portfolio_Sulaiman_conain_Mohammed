...
A professional Flask application that allows users to upload their resumes and then HR managers can interact with an AI chatbot that represents the candidate during interviews.
