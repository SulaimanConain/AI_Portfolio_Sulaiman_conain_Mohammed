...
A professional Flask application that allows HR managers to upload candidate resumes and interact with an AI chatbot that represents the candidate during interviews.
